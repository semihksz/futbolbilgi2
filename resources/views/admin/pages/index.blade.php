                ...
                <div class="card-body">
                    ...
                    <div class="row g-4 align-items-center mb-4">
                        <div class="col-12 col-xl-4">
                            ...
                            <p class="mb-0">In publishing and graphic design, Lorem ipsum is a
                    ...
                    <div
                        class="d-flex flex-column flex-lg-row align-items-lg-center align-self-end justify-content-lg-between border p-3 gap-3 mb-0 rounded-3">
                        <div class="d-flex align-items-center gap-3">
