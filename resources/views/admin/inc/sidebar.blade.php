<aside class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <img src="{{ asset('assets/backend/images/galatasaray.png') }}" class="logo-icon" alt="logo icon">
        </div>
        <div>
            <h6 class="logo-text text-danger">Galatasaray</h6>
        </div>
    </div>
    <!--navigation-->
    <ul class="metismenu" id="menu">
        ...
        <li class="menu-label">Branşlar</li>
        <li>
